...
void Decoder_OSWrapper_Destroy(void *decoder);
void Decoder_OSWrapper_Rewind(void *decoder);
size_t Decoder_OSWrapper_GetSamples(void *decoder, short *buffer, size_t frames_to_do);
